...
<body class="fashion">
			...
			<div class="row">
				<div class="col-xs-12 padding-noh">
					<div class="title-anchor">
						<span>当前位置：<a href="../../index.php">首页</a> > <a href="star_index.php">星姿态</a> > 明星风尚</span>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="block2">
		<div class="container">
			<div class="row">
				<div class="col-xs-12">
					<div class="all-title">明星风尚 STAR STYLE</div>
				</div>
				<div class="col-xs-12 top-banner">
					<div class="col-xs-12 col-sm-3 remove-padding-x">
						<a class="mask-text" href="#">						
							<img src="../../images/m24.jpg">
							<div class="text-wrap"><span class="hid">杨洋发布会现场撩女粉丝 避谈与宋茜绯闻</span><div class="mask-mask"></div></div>
						</a>
					</div>
					<div class="col-xs-12 col-sm-3 remove-padding-x">
						<a class="mask-text" href="#">						
							<img src="../../images/m25.jpg">
							<div class="text-wrap"><span class="hid">吴莫愁跨风格演绎多变人生 时尚无限可能</span><div class="mask-mask"></div></div>
						</a>
					</div>
					<div class="col-xs-12 col-sm-3 remove-padding-x">
						<a class="mask-text" href="#">						
							<img src="../../images/m26.jpg">
							<div class="text-wrap"><span class="hid">X宝明星同款 你确定不是出来搞笑的</span><div class="mask-mask"></div></div>
						</a>
					</div>
					<div class="col-xs-12 col-sm-3 remove-padding-x">
						<a class="mask-text" href="#">						
							<img src="../../images/m27.jpg">
							<div class="text-wrap"><span class="hid">女星最新僵脸报告 变脸是个大坑慎入啊</span><div class="mask-mask"></div></div>
						</a>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-3">
					<a class="item-card" href="star_3.php">
						<span class="s1"></span>
						<span class="item-card-mask"></span>
						<img src="../../images/d16.jpg">
						<span class="card-text"><span>细数女神几大硬件标配 那一头撩汉秀发我也想要</span></span>
						<span class="s2"></span>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3">
					<a class="item-card" href="#">
						...
						<span class="card-text"><span>夏季出汗及运动频繁洗发的解决办法</span></span>
						<span class="s2"></span>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3">
					<a class="item-card" href="#">
						...
						<span class="card-text"><span>妈妈告诉你的这 22 件事一定是正确的</span></span>
						<span class="s2"></span>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3">
					<a class="item-card" href="#">
						...
						<span class="card-text"><span>谭维维不同场合秀穿搭，将时尚和个性进行到底</span></span>
						<span class="s2"></span>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3 col-sm-offset-1">
					<a class="item-card" href="#">
						...
						<span class="card-text"><span>李沁亮相浪琴表马术活动，简约优雅不失少女率性</span></span>
						<span class="s2"></span>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3">
					<a class="item-card" href="#">
						<span class="s1"></span>
						<span class="item-card-mask"></span>
						<img src="../../images/d21.jpg">
						<span class="card-text"><span>和老婆饼里没老婆比起来，星巴克变成“冰巴克”真的不算什么</span></span>
						<span class="s2"></span>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3">
					<a class="item-card" href="#">
						<span class="s1"></span>
						<span class="item-card-mask"></span>
						<img src="../../images/d22.jpg">
						<span class="card-text"><span>这些都是2016年夏季好莱坞最热门发型</span></span>
						<span class="s2"></span>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3">
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-3">
					<a href="#" class="bottom-item">
						<img src="../../images/d23.jpg">
						<div>玩出新花样 华为正式发布揽阅M2青春版定义“平板手机”</div>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3">
					<a href="#" class="bottom-item">
						<img src="../../images/m28.jpg">
						<div>赵丽颖恋情疑坐实全程甜蜜陪伴</div>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3">
					<a href="#" class="bottom-item">
						<img src="../../images/m29.jpg">
						<div>侯佩岑与老公合影正面首被曝</div>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3">
					<a href="#" class="bottom-item">
						<img src="../../images/m30.jpg">
						<div>赵薇&女儿 恰如人间四月天般美好</div>
					</a>
				</div>
			</div>
		</div>
	...
	<script src="../../js/star_style.js"></script>
