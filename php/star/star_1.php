			...
			<div class="row">
				<div class="col-xs-12 padding-noh">
					<div class="title-anchor">
						<span>当前位置：<a href="../../index.php">首页</a> > <a href="star_index.php">星姿态</a> > 正文</span>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-xs-12 gallery-wrap-all remove-padding-x">
					<div class="image-gallery-wrap">
						...
						<div class="text-top">
							当年，言承旭饰演的道明寺，也是很多人第一个男神的模样。随着年龄的增长，F4
							各自的人生都在经历着变化。但唯独言承旭，可能是过于低调吧，无论是角色类型
							还是感情经历，给人的感觉总是在原地踏步。
						</div>
						<ul class="image-list">
							<li><img src="../../images/x25.jpg" ></li>
							<li><img src="../../images/x26.jpg" ></li>
							<li><img src="../../images/x27.jpg" ></li>
							<li><img src="../../images/x28.jpg" ></li>
							
							
						</ul>
						<div class="image-list-thumbs">
							<div class="image-item-wrap">
								<div class="image-item selected" type-text="两个人拍戏时结缘，去年6月恋情曝光，前日在韩雯雯生日宴上，朱孝天浪漫求婚。除了送上“求婚标配”——钻戒+玫瑰之外，同时献唱《流星花园》主题歌《情非得已》，勾起不少回忆！刚刚求婚成功两人便趁热打铁领了证！一点都不耽误呢~">
									<img class="micro" src="../../images/x25.jpg" >
								</div>
							</div>
							<div class="image-item-wrap">
								<div class="image-item " type-text="F4中最早为人夫的吴建豪虽然结婚后狗血八卦不断，但人家可是最早拥有自己的家庭呢，很值得自豪~">
									<img class="micro" src="../../images/x26.jpg" >
								</div>
							</div>
							<div class="image-item-wrap">
								<div class="image-item " type-text="已经15年过去了，2001年《流星花园》全亚洲热播，可以说是童年里不可或缺的一部分，前几年江苏卫视F4合体也让很多网友们感慨道：只有他们四个站在一起，才是我们光芒万丈的青春。">
									<img class="micro" src="../../images/x27.jpg" >
								</div>
							</div>
							<div class="image-item-wrap">
								<div class="image-item " type-text="朱孝天昨天领证结婚了！与内地女星韩雯雯的爱情修成正果~">
									<img class="micro" src="../../images/x28.jpg" >
								</div>
							</div>
						...
						<div class="image-text">
							两个人拍戏时结缘，去年6月恋情曝光，前日在韩雯雯生日宴上，朱孝天浪漫求婚。除了送上“求婚标配”——钻戒
						</div>
					</div>
				</div>
			</div>
