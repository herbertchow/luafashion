...
<head>
	...
	<title>彩妆--路雅时尚网</title>
	<link rel="stylesheet" href="../../bootstrap/css/bootstrap.min.css">
	<link rel="stylesheet" href="../../font-awesome/css/font-awesome.min.css">
	<link rel="stylesheet" href="../../css/public.css">
	<link rel="stylesheet" href="../../css/beauty_makeup.css">
	<!--[if lt IE 9]>
...
<body class="fashion">
			...
			<div class="row">
				<div class="col-xs-12 padding-noh">
					<div class="title-anchor">
						<span>当前位置：<a href="../../index.php">首页</a> > <a href="beauty_index.php">美容</a> > 彩妆</span>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="block2">
		<div class="container">
			<div class="row">
				<div class="col-xs-12">
					<div class="all-title">彩妆 MAKEUP</div>
				</div>
				<div class="col-xs-12 top-banner">
					...
					<div class="col-xs-12 col-sm-3 remove-padding-x">
						<a class="mask-text" href="#">						
							...
							<div class="text-wrap"><span class="hid">秦海璐示范亮眼春妆 百变“姨妈红”展极致魅力</span><div class="mask-mask"></div></div>
						</a>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-3">
					<a class="item-card" href="#">
						...
						<span class="card-text"><span>透明白皙的美肌小秘密</span></span>
						<span class="s2"></span>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3">
					<a class="item-card" href="#">
						...
						<span class="card-text"><span>2016最新最好的唇彩都在这里</span></span>
						<span class="s2"></span>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3">
					<a class="item-card" href="#">
						...
						<span class="card-text"><span>怎么办？这支隔离霜快把我宠坏</span></span>
						<span class="s2"></span>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3">
					<a class="item-card" href="#">
						...
						<span class="card-text"><span>古力娜扎也在用的隔离霜，剁手也要买！</span></span>
						<span class="s2"></span>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3 col-sm-offset-1">
					<a class="item-card" href="#">
						...
						<span class="card-text"><span>“妆”腔作势 我是去音乐节自拍的</span></span>
						<span class="s2"></span>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3">
					<a class="item-card" href="#">
						...
						<span class="card-text"><span>6个事项教你清洁保护你的化妆刷</span></span>
						<span class="s2"></span>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3">
					<a class="item-card" href="#">
						...
						<span class="card-text"><span>关于修眉的这些方法，你都知道吗？</span></span>
						<span class="s2"></span>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3">
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-3">
					<a href="#" class="bottom-item">
						...
						<div>从三线小咖到顶级明星 仅仅是一个发型的距离</div>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3">
					<a href="#" class="bottom-item">
						<img src="../../images/b20.jpg">
						<div>盘点7个抢了女人“饭碗”的男人们</div>
					</a>
				</div>
			</div>
		</div>
	...
	<script src="../../js/beauty_makeup.js"></script>
