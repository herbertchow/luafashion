...
<head>
	...
	<title>秀发--路雅时尚网</title>
	<link rel="stylesheet" href="../../bootstrap/css/bootstrap.min.css">
	<link rel="stylesheet" href="../../font-awesome/css/font-awesome.min.css">
	<link rel="stylesheet" href="../../css/public.css">
	<link rel="stylesheet" href="../../css/beauty_hairdress.css">
	<!--[if lt IE 9]>
...
<body class="fashion">
			...
			<div class="row">
				<div class="col-xs-12 padding-noh">
					<div class="title-anchor">
						<span>当前位置：<a href="../../index.php">首页</a> > <a href="beauty_index.php">美容</a> > 秀发</span>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="block2">
		<div class="container">
			<div class="row">
				<div class="col-xs-12">
					<div class="all-title">秀发 HAIRDRESS</div>
				</div>
				<div class="col-xs-12 top-banner">
					...
					<div class="col-xs-12 col-sm-3 remove-padding-x">
						<a class="mask-text" href="#">						
							<img src="../../images/s61.jpg">
							<div class="text-wrap"><span class="hid">小长假不想剪高俊熙同款发型的你可以找孙俪啊</span><div class="mask-mask"></div></div>
						</a>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-3">
					<a class="item-card" href="#">
						...
						<span class="card-text"><span>春天做女神离不开这 17 款编发！</span></span>
						<span class="s2"></span>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3">
					<a class="item-card" href="#">
						...
						<span class="card-text"><span>杨幂、林允儿、鹿晗都这么玩 4 种刘海扎法洋气 100 倍</span></span>
						<span class="s2"></span>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3">
					<a class="item-card" href="#">
						...
						<span class="card-text"><span>不看吃亏！你们女神用的东西都在这</span></span>
						<span class="s2"></span>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3">
					<a class="item-card" href="#">
						...
						<span class="card-text"><span>颜值高才敢这么剪 3款短发90%的男人都夸好</span></span>
						<span class="s2"></span>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3 col-sm-offset-1">
					<a class="item-card" href="#">
						...
						<span class="card-text"><span>这么妆最能勾起男人的撩妹欲</span></span>
						<span class="s2"></span>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3">
					<a class="item-card" href="#">
						...
						<span class="card-text"><span>3款最丑的男人发型 作践的可全是女人</span></span>
						<span class="s2"></span>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3">
					<a class="item-card" href="#">
						...
						<span class="card-text"><span>别人的刘海你不配！ 二八偏分才是你的菜</span></span>
						<span class="s2"></span>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3">
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-3">
					<a href="#" class="bottom-item">
						...
						<div>拿走不谢！2招搞定你的“黑眼圈”</div>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3">
					<a href="beauty_2.php" class="bottom-item">
						<img src="../../images/a3.jpg">
						<div>女生的脸不能吹?怪你不会打底咯</div>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3">
					<a href="#" class="bottom-item">
						<img src="../../images/a4.jpg">
						<div>看完这篇后!我知道你对“它”上瘾了</div>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3">
					<a href="#" class="bottom-item">
						<img src="../../images/d1.jpg">
						<div>秦海璐示范亮眼春妆 百变“姨妈红”展极致魅力</div>
					</a>
				</div>
			</div>
		</div>
	...
	<script src="../../js/beauty_hairdress.js"></script>
