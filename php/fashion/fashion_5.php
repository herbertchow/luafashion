			...
			<div class="row">
				<div class="col-xs-12 gallery-wrap-all remove-padding-x">
					<div class="image-gallery-wrap">
						...
						<div class="text-top">
							其实时装周对于我们大部分人来说都只不过千言万语汇成一句话“关我屁事”，要说有联系，
							大概就是从街头的街拍照片里学点什么，看看明天怎么穿。
							尤其是在这个冬末春初的换季时候里，明天到底穿什么，还得去时装周的街拍照片里找找灵感。
							依葫芦画瓢总不会错！
						</div>
						<ul class="image-list">
							<li><img src="../../images/x85.jpg" ></li>
							<li><img src="../../images/x86.jpg" ></li>
							<li><img src="../../images/x87.jpg" ></li>
							<li><img src="../../images/x88.jpg" ></li>
							
						</ul>
						<div class="image-list-thumbs">
							<div class="image-item-wrap">
								<div class="image-item selected" type-text="温度略有回升的这几天，我们终于可以名正言顺的脱去厚重的皮草、羽绒服，换上薄外套。开衫虽然不厚，但是别拿它不当外套，穿起来，好看着呢！">
									<img class="micro" src="../../images/x85.jpg" >
								</div>
							</div>
							<div class="image-item-wrap">
								<div class="image-item " type-text="眼看着天气预报北方的气温开始逐步回到0度以上，眼见意味着就到了那个： 光腿穿长靴，皮草敞着穿的炫酷时节了！">
									<img class="micro" src="../../images/x86.jpg" >
								</div>
							</div>
							<div class="image-item-wrap">
								<div class="image-item " type-text="小仙女们作妖作怪打扮的最佳季节又开始了呢，你准备好了嘛？">
									<img class="micro" src="../../images/x87.jpg" >
								</div>
							</div>
							<div class="image-item-wrap">
								<div class="image-item " type-text="其实外套叠穿的概念我们之前已经讲过，但在这次的纽约街头，我们看到了很多达人纷纷用牛仔外套做内搭。">
									<img class="micro" src="../../images/x88.jpg" >
								</div>
							</div>
						...
						<div class="image-text">
							温度略有回升的这几天，我们终于可以名正言顺的脱去厚重的皮草、羽绒服，换上薄外套。开衫虽然不厚，但是别拿它不当外套，穿起来，好看着呢！
						</div>
					</div>
				</div>
			</div>
