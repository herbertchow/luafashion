			...
			<div class="row">
				<div class="col-xs-12 gallery-wrap-all remove-padding-x">
					<div class="image-gallery-wrap">
						...
						<div class="text-top">
							2001年，Tomas Maier成为Bottega Veneta创意总监后亲自设计了Cabat手袋。
							Cabat源自法语“篮子”——寓意挺阔实用的外形。
							每只手袋都以最柔软的Nappa小羊皮，纯手工Intrecciato编织皮艺术和“Tie And Dye”扎染工艺打造。
						</div>
						<ul class="image-list">
							<li><img src="../../images/x89.jpg" ></li>
							<li><img src="../../images/x90.jpg" ></li>
							<li><img src="../../images/x91.jpg" ></li>
							<li><img src="../../images/x92.jpg" ></li>
				
						</ul>
						<div class="image-list-thumbs">
							<div class="image-item-wrap">
								<div class="image-item selected" type-text="Bottega Veneta 黑色编织小羊皮购物袋 参考价格：24,426CNY">
									<img class="micro" src="../../images/x89.jpg" >
								</div>
							</div>
							<div class="image-item-wrap">
								<div class="image-item " type-text="Bottega Veneta Knot 柠檬黄蛇皮纹手拿包 参考价格：26,174CNY">
									<img class="micro" src="../../images/x90.jpg" >
								</div>
							</div>
							<div class="image-item-wrap">
								<div class="image-item " type-text="　Bottega Veneta Knot 蒙娜丽莎色编织真丝长款手拿包 参考价格：11,280CNY">
									<img class="micro" src="../../images/x91.jpg" >
								</div>
							</div>
							<div class="image-item-wrap">
								<div class="image-item " type-text="Bottega Veneta Veneta 净沙色编织小羊皮大号背包 参考价格：18,078CNY">
									<img class="micro" src="../../images/x92.jpg" >
								</div>
							</div>
				
						</div>
						<div class="image-text">
							Bottega Veneta 黑色编织小羊皮购物袋 参考价格：24,426CNY
						</div>
					</div>
				</div>
			</div>
