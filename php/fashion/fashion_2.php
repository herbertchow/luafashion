...
<head>
	...
	<link rel="stylesheet" href="../../css/fashion_2.css">
	<!--[if lt IE 9]>
...
<body class="fashion">
			...
			<div class="row">
				<div class="col-xs-12 gallery-wrap-all remove-padding-x">
					<div class="image-gallery-wrap">
						...
						<div class="text-top">
							在时尚圈最忌讳的就是烂大街，无论是一件单品or一种搭配趋势，一旦人人都开始
							穿再美也变得可怕起来。而面对即将到来的16春夏，你确定你get到了正确的搭配趋
							势了吗？今天就为大家介绍眼下欧美最时髦的潮人搭配，趁还没烂大街之前赶紧穿起来吧！
						</div>
						<ul class="image-list">
							<li><img src="../../images/x6.jpg" ></li>
							<li><img src="../../images/x7.jpg" ></li>
							<li><img src="../../images/x8.jpg" ></li>
							<li><img src="../../images/x9.jpg" ></li>
							<li><img src="../../images/x10.jpg" ></li>
							<li><img src="../../images/x11.jpg" ></li>
							<li><img src="../../images/x12.jpg" ></li>
							<li><img src="../../images/x13.jpg" ></li>
							<li><img src="../../images/x14.jpg" ></li>
						</ul>
						<div class="image-list-thumbs">
							<div class="image-item-wrap">
								<div class="image-item selected" type-text="军绿色的短夹克搭配柠檬黄色大长裙，chic之中洋溢着优雅与活力感。">
									<img class="micro" src="../../images/x6.jpg" >
								</div>
							</div>
							<div class="image-item-wrap">
								<div class="image-item " type-text="搭细围巾和紧身牛仔，可以选择一双有设计感的长靴来增强时髦感。">
									<img class="micro" src="../../images/x7.jpg" >
								</div>
							</div>
							<div class="image-item-wrap">
								<div class="image-item " type-text="除了纯色，搭配印花大长裙也是个不错的选择。">
									<img class="micro" src="../../images/x8.jpg" >
								</div>
							</div>
							<div class="image-item-wrap">
								<div class="image-item " type-text="舒服到爆的短襟连帽衫搭配银色漆皮长裤，既休闲又不失时尚度。">
									<img class="micro" src="../../images/x9.jpg" >
								</div>
							</div>
							<div class="image-item-wrap">
								<div class="image-item " type-text="普通的拉链帽衫如果搭配一款设计吸睛的长裙，看起来就不怕有屌丝感啦。">
									<img class="micro" src="../../images/x10.jpg" >
								</div>
							</div>
							<div class="image-item-wrap">
								<div class="image-item " type-text="或者用作内搭，外面来一件型爆的做旧款机车夹克吧。">
									<img class="micro" src="../../images/x11.jpg" >
								</div>
							</div>
							<div class="image-item-wrap">
								<div class="image-item " type-text="缤纷的针织条纹连衣裙既优雅又不失活泼感。">
									<img class="micro" src="../../images/x12.jpg" >
								</div>
							</div>
							<div class="image-item-wrap">
								<div class="image-item " type-text="彩虹配色条纹针织衫搭配牛仔裤，让你穿出嬉皮风情。">
									<img class="micro" src="../../images/x13.jpg" >
								</div>
							</div>
							<div class="image-item-wrap">
								<div class="image-item " type-text="半身裙也是个不错的选择，细细的竖条纹无需担心显胖的问题了。">
									<img class="micro" src="../../images/x14.jpg" >
								</div>
							</div>
				
						</div>
						<div class="image-text">
							军绿色的短夹克搭配柠檬黄色大长裙，chic之中洋溢着优雅与活力感。
						</div>
					</div>
				</div>
			</div>
	...
	<script src="../../js/fashion_2.js"></script>
