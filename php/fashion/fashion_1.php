	...
	<div class="block2">
		<div class="container">
			<div class="row">
				<div class="col-xs-12">
					<div class="big-title">
						范冰冰弃驴蹄也要穿的鞋 它才是Louis Vuitton的主角
					</div>
			...
			<div class="row">
				<div class="col-xs-12 gallery-wrap-all remove-padding-x">
					<div class="image-gallery-wrap">
						...
						<div class="text-top">
							Louis Vuitton 2016秋冬大秀举行，作为时装周的压轴，虽然当天巴
							黎阴雨绵绵，但依旧阻挡不了范冰冰、唐嫣、刘雯等大咖们朝圣的热情。
						</div>
						<ul class="image-list">
						...
						<div class="image-list-thumbs">
							<div class="image-item-wrap">
								<div class="image-item selected" type-text="恋爱后变为小女人的范冰冰，再次开启女王模式，化身异次元女战士。">
									<img class="micro" src="../../images/x1.jpg" >
								</div>
							</div>
							<div class="image-item-wrap">
								<div class="image-item " type-text="LV经典红色皮衣搭配耀眼的耳饰，冷艳又时尚十足的都市摩登范。">
									<img class="micro" src="../../images/x2.jpg" >
								</div>
							</div>
							<div class="image-item-wrap">
								<div class="image-item " type-text="不仅如此，范爷身上的小配件也是整个造型的点睛之处，处处有亮点。">
									<img class="micro" src="../../images/x3.jpg" >
								</div>
							</div>
							<div class="image-item-wrap">
								<div class="image-item " type-text="LV经典红色皮衣搭配耀眼的耳饰，冷艳又时尚十足的都市摩登范。">
									<img class="micro" src="../../images/x4.jpg" >
								</div>
							</div>
							<div class="image-item-wrap">
								<div class="image-item " type-text="不仅如此，范爷身上的小配件也是整个造型的点睛之处，处处有亮点。">
									<img class="micro" src="../../images/x5.jpg" >
								</div>
							</div>
						...
						<div class="image-text">
							恋爱后变为小女人的范冰冰，再次开启女王模式，化身异次元女战士。
						</div>
					</div>
				</div>
			</div>
