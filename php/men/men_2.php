			...
			<div class="row">
				<div class="col-xs-12 gallery-wrap-all remove-padding-x">
					<div class="image-gallery-wrap">
						...
						<div class="text-top">
							衰老是让人心碎的话题，它不可避免，逐渐降临......好在时尚圈里的帅大叔们做
							出了表率，岁月在他们脸上留下的痕迹，却都变成了魅力的象征——这才是正确的态
							度，聪明地预防衰老，让它慢慢出现。
						</div>
						<ul class="image-list">
							<li><img src="../../images/x54.jpg" ></li>
							<li><img src="../../images/x55.jpg" ></li>
							<li><img src="../../images/x56.jpg" ></li>
					
							
						</ul>
						<div class="image-list-thumbs">
							<div class="image-item-wrap">
								<div class="image-item selected" type-text="当皮肤老化后，伴随而来的是面部瑕疵明显：皮肤的斑点越来越容易显现;皮肤屏障功能变差，容易敏感;皮肤新陈代谢的能力降低，角质堆积，导致面部皮肤粗糙。">
									<img class="micro" src="../../images/x54.jpg" >
								</div>
							</div>
							<div class="image-item-wrap">
								<div class="image-item " type-text="皱纹是皮肤老化的标志，一方面，老化的细胞剥离和新生细胞之间的平衡被打破，面部表情后无法及时恢复原形从而产生皱褶;另外，自由基会破坏胶原蛋白、活性物质，也是形成皱纹的原因。">
									<img class="micro" src="../../images/x55.jpg" >
								</div>
							</div>
							<div class="image-item-wrap">
								<div class="image-item " type-text="随着年龄增加，胶原蛋白流失的速度变快，胶原纤维和弹性纤维的弹性降低、受损，甚至断裂，就会导致支撑皮肤的天然支持架构塌陷;因为胶原纤维合成数量减少而逐渐变薄，使得真皮层对表皮支撑力变差，形成面部松弛。">
									<img class="micro" src="../../images/x56.jpg" >
								</div>
							</div>
						...
						<div class="image-text">
							当皮肤老化后，伴随而来的是面部瑕疵明显：皮肤的斑点越来越容易显现;皮肤屏障功能变差，容易敏感;皮肤新陈代谢的能力降低，角质堆积，导致面部皮肤粗糙。
						</div>
					</div>
				</div>
			</div>
