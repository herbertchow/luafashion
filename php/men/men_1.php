...
<head>
	...
	<title>男士详情--路雅时尚网</title>
	<link rel="stylesheet" href="../../bootstrap/css/bootstrap.min.css">
	<link rel="stylesheet" href="../../font-awesome/css/font-awesome.min.css">
	<link rel="stylesheet" href="../../css/public.css">
	<link rel="stylesheet" href="../../css/men_1.css">
	<!--[if lt IE 9]>
			...
			<div class="row">
				<div class="col-xs-12 padding-noh">
					<div class="title-anchor">
						<span>当前位置：<a href="../../index.php">首页</a> > <a href="men_index.php">男士</a> > 正文</span>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-xs-12 gallery-wrap-all remove-padding-x">
					<div class="image-gallery-wrap">
						...
						<div class="text-top">
							来了春季，丢了厚重的衣服，而早晚温差，也让人摸不着头脑，乱穿衣的节奏来了。
							单批一件驼色大衣，用早春的元素点缀，厚与薄的混搭，让过季的驼色大衣鲜嫩时
							尚。其实你可理解成为:驼色大衣换季扮嫩法则。
						</div>
						<ul class="image-list">
							<li><img src="../../images/x20.jpg" ></li>
							<li><img src="../../images/x21.jpg" ></li>
							<li><img src="../../images/x22.jpg" ></li>
							<li><img src="../../images/x23.jpg" ></li>
							<li><img src="../../images/x24.jpg" ></li>
							
						</ul>
						<div class="image-list-thumbs">
							<div class="image-item-wrap">
								<div class="image-item selected" type-text="薄款衬衣与大衣调整温度平衡，清爽色让整身搭配不显臃肿。选一款围巾，特殊的图案与花纹，需要有颜色跳跃感。长度不限，厚度不限，随意的披肩围裹，让驼色增添质感层次。">
									<img class="micro" src="../../images/x20.jpg" >
								</div>
							</div>
							<div class="image-item-wrap">
								<div class="image-item " type-text="此种配搭，是把驼色大衣当西装外套。你可直接省略西装啦！不用考虑太多，直接搭配马甲以及同色系的裤装，简单的白色衬衣，讲究一点的细窄暗色领带，有着一点复古的绅士老炮味道。">
									<img class="micro" src="../../images/x21.jpg" >
								</div>
							</div>
							<div class="image-item-wrap">
								<div class="image-item " type-text="这里的双排扣西装有着不严肃的穿法，不用太矫情领带，衬衣的配搭，套装也可随意拆解，搭配牛仔不教条。记住再来一双运动鞋点缀，让驼色大衣变得活泼些。 god！简直性感的不行…">
									<img class="micro" src="../../images/x22.jpg" >
								</div>
							</div>
							<div class="image-item-wrap">
								<div class="image-item " type-text="速效提神的针织帽，以及时尚运动的运动鞋，让传统的驼色H型大衣变得轻盈运动，西裤的裤角变窄，让大衣更具廓型味道。在拉伸腿部比例的同时，帽子也增加了高度。">
									<img class="micro" src="../../images/x23.jpg" >
								</div>
							</div>
							<div class="image-item-wrap">
								<div class="image-item " type-text="此款装备，重点在于特色的肥腿裤，不要纠结于是格子的还是军装范，只要肥腿宽松，保证九分裤最为潮流，因为裸露脚踝才年轻。">
									<img class="micro" src="../../images/x24.jpg" >
								</div>
							</div>
						...
						<div class="image-text">
							薄款衬衣与大衣调整温度平衡，清爽色让整身搭配不显臃肿。选一款围巾，特殊的图案与花纹，需要有颜色跳跃感。长度不限，厚度不限，随意的披肩围裹，让驼色增添质感层次。
						</div>
					</div>
				</div>
			</div>
