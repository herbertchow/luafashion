			...
			<div class="row">
				<div class="col-xs-12 gallery-wrap-all remove-padding-x">
					<div class="image-gallery-wrap">
						...
						<div class="text-top">
							秋冬季节外套是我们必备的单品，而小西装外套就比不可少的哦。其实中长款的小西
							装外套穿起来更加显优雅气质哦，韩版的搭配起来也比较适合潮男们，赶紧来看看吧！
						</div>
						<ul class="image-list">
							<li><img src="../../images/x60.jpg" ></li>
							<li><img src="../../images/x61.jpg" ></li>
							<li><img src="../../images/x62.jpg" ></li>
							<li><img src="../../images/x63.jpg" ></li>
							
						</ul>
						<div class="image-list-thumbs">
							<div class="image-item-wrap">
								<div class="image-item selected" type-text="造型和细节处理都打破了传统大衣呆板无奇的形式，注入了一些青春活力的个性，中长款设计，永不过时，经典的纯色更容易搭配，精细做工，追求品质。">
									<img class="micro" src="../../images/x60.jpg" >
								</div>
							</div>
							<div class="image-item-wrap">
								<div class="image-item " type-text="中长款设计，低调黄色，优质面料，特选复古扣子，细节处彰显品质！">
									<img class="micro" src="../../images/x61.jpg" >
								</div>
							</div>
							<div class="image-item-wrap">
								<div class="image-item " type-text="帅气西装领，百搭纯色，干净利落，彰显男鞋魅力，走线紧密精细">
									<img class="micro" src="../../images/x62.jpg" >
								</div>
							</div>
							<div class="image-item-wrap">
								<div class="image-item " type-text="时尚的版型设计，个性的西装领设计，采用优质面料，在衣服的穿着舒适度上，时尚西装领设计，简约大气，不失男士风范，时尚的竖插袋，方便舒适">
									<img class="micro" src="../../images/x63.jpg" >
								</div>
							</div>
						...
						<div class="image-text">
							造型和细节处理都打破了传统大衣呆板无奇的形式，注入了一些青春活力的个性，中长款设计，永不过时，经典的纯色更容易搭配，精细做工，追求品质。
						</div>
					</div>
				</div>
			</div>
