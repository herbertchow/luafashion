...
<div class="login-wrap">
	<div class="hidden-xs">
		<div class="container text-right ">
			...
			<a href="php/config/logout.php"><span class="btn btn-sm btn-my-white btn-reg">退出</span></a>
		</div>
	</div>
	<div class="hidden-lg hidden-md hidden-sm">
		<div class="container text-left ">
			...
			<a href="php/config/logout.php"><span class="btn btn-sm btn-default btn-reg">退出</span></a>
