			...
			<div class="row">
				<div class="col-xs-12 gallery-wrap-all remove-padding-x">
					<div class="image-gallery-wrap">
						...
						<div class="text-top">
							一说起好酒店，你多半会想象美国、英法和迪拜之类的吧？无拘无束的美国海岸，英
							法的管家、迪拜的豪华……呐，不要这样，德国人虽然以理性，冷酷，精密，守时著称，
							但是他们自由、奔放起来也不是盖的，难道你忘记了那些帅哥足球运动员了吗？
						</div>
						<ul class="image-list">
							<li><img src="../../images/x75.jpg" ></li>
							<li><img src="../../images/x76.jpg" ></li>
							<li><img src="../../images/x77.jpg" ></li>
						
						</ul>
						<div class="image-list-thumbs">
							<div class="image-item-wrap">
								<div class="image-item selected" type-text="凯宾斯基柏林阿德隆酒店 Hotel Adlon Kempinski Berlin~">
									<img class="micro" src="../../images/x75.jpg" >
								</div>
							</div>
							<div class="image-item-wrap">
								<div class="image-item " type-text="柏林地标性建筑勃兰登堡门下一段百年佳话，旧时代柏林望族不惜卖掉冬日别墅只为拥有一间优雅套房的传奇酒店。酒店周边名胜景点、大牌商店、画廊、剧院环绕，位置绝佳。">
									<img class="micro" src="../../images/x76.jpg" >
								</div>
							</div>
							<div class="image-item-wrap">
								<div class="image-item " type-text="你是否憧憬着夜晚入眠时敞着窗户，让月光流泻到你床边？或是在露台上俯瞰城市的风景？在曼陀罗酒店，你完全可以去体验梦寐以求的夜色浪漫，全然不被打扰。">
									<img class="micro" src="../../images/x77.jpg" >
								</div>
							</div>
						...
						<div class="image-text">
							凯宾斯基柏林阿德隆酒店 Hotel Adlon Kempinski Berlin~
						</div>
					</div>
				</div>
			</div>
