...
<head>
	...
	<title>情感--路雅时尚网</title>
	<link rel="stylesheet" href="../../bootstrap/css/bootstrap.min.css">
	<link rel="stylesheet" href="../../font-awesome/css/font-awesome.min.css">
	<link rel="stylesheet" href="../../css/public.css">
	<link rel="stylesheet" href="../../css/life_emotion.css">
	<!--[if lt IE 9]>
...
<body class="fashion">
			...
			<div class="row">
				<div class="col-xs-12 padding-noh">
					<div class="title-anchor">
						<span>当前位置：<a href="../../index.php">首页</a> > <a href="life_index.php">生活</a> > 情感</span>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="block2">
		<div class="container">
			<div class="row">
				<div class="col-xs-12">
					<div class="all-title">情感 EMOTION</div>
				</div>
				<div class="col-xs-12 col-sm-9">
					<a href="#" class="banner">
						<img src="../../images/s3.jpg">
						<div><span>心情不好时，这8个岛屿是我的避风港</span></div>
					</a>
					<div class="item-wrap active" type="1">
						<div class="item-detail">
							<a href="#"><img src="../../images/s13.jpg"></a>
							<span class="detail-right">
								<a href="#"><span class="detail-title">“迷你型”女生的7个魅力瞬间</span></a>
								<span class="detail-text">聊天时自然仰起头看着男生的脸，对男生而言就是让人心
								跳加速的绝对视角。从这个角度看到你的大眼睛和根根分明的睫毛，忍不住就掉进你的
								魅力漩涡中，好想拍拍头或将你一把揽进......</span>
						...
						<div class="item-detail">
							<a href="#"><img src="../../images/s14.jpg"></a>
							<span class="detail-right">
								<a href="#"><span class="detail-title">选对6种旺妻男 生活甜似蜜糖</span></a>
								<span class="detail-text">这是首先一条，旺妻的男人在骨子里一定要有男女平等的
								思想和意识，如此他才会真正去善待妻子，才会真正发自内心去尊重妻子，才不会把妻子
								当作自 已的附属物或是生儿育女的工具......</span>
								<span class="detail-bottom"><i class="fa js-co fa-heart-o"></i>
									<a><span class="share-btn">分享</span><span class="share-wrap"><i class="fa fa-qq"></i>
									<i class="fa fa-weixin"></i><i class="fa fa-weibo"></i><i class="fa fa-close"></i></span></a>
								</span>
						...
						<div class="item-detail">
							<a href="#"><img src="../../images/h10.jpg"></a>
							<span class="detail-right">
								<a href="#"><span class="detail-title">这是个男人钟爱坏女人的时代</span></a>
								<span class="detail-text">乖女人总会把家里整理的干干净净，坏女人总会把自己整理
								的漂漂亮亮。虽然女人把家里整理干净可以把男人的归属感留下，但别忘了整理家里之外
								还要把自己整理好，男人都是感官动物，不把......</span>
								<span class="detail-bottom"><i class="fa js-co fa-heart-o"></i>
									<a><span class="share-btn">分享</span><span class="share-wrap"><i class="fa fa-qq"></i>
									<i class="fa fa-weixin"></i><i class="fa fa-weibo"></i><i class="fa fa-close"></i></span></a>
								</span>
						...
						<div class="item-detail">
							<a href="#"><img src="../../images/h11.jpg"></a>
							<span class="detail-right">
								<a href="#"><span class="detail-title">拥有这些特征的渣男谨慎交往</span></a>
								<span class="detail-text">如果你的另一半是一个内敛而含蓄的传统男人，那么他对
								于感情的表达亦是如此，如果在一个浪漫的周末你问他做什么？或者是他对你的第一印
								象，那么请认真阅读以下18个秘密，透过......</span>
								<span class="detail-bottom"><i class="fa js-co fa-heart-o"></i>
									<a><span class="share-btn">分享</span><span class="share-wrap"><i class="fa fa-qq"></i>
									<i class="fa fa-weixin"></i><i class="fa fa-weibo"></i><i class="fa fa-close"></i></span></a>
								</span>
						...
						<div class="item-detail">
							<a href="#"><img src="../../images/h12.jpg"></a>
							<span class="detail-right">
								<a href="#"><span class="detail-title">不留遗憾 倒追男人的5大策略</span></a>
								<span class="detail-text">当你跟他在一起的时候，他可能只把你当做是女性的哥们，
								但如果你对他已经超越了普通的男女感情，那就应该从男人的角度考虑他对你的感受。比
								如为了赢得他对你的关注，你可以先从待......</span>
								<span class="detail-bottom"><i class="fa js-co fa-heart-o"></i>
									<a><span class="share-btn">分享</span><span class="share-wrap"><i class="fa fa-qq"></i>
									<i class="fa fa-weixin"></i><i class="fa fa-weibo"></i><i class="fa fa-close"></i></span></a>
								</span>
				...
				<div class="col-xs-12 col-sm-3">
					<div class="subject-top">
						...
						<div class="subject-top-title change js-o">换一组</div>
					</div>
					<div class="right-one-t">
						<a href="#" class="right-one">
							<img src="../../images/s9.jpg">
							<div>带上宠物去旅行 住这13个酒店最合适了</div>
						</a>
						<a href="#" class="right-one">
					...
					<div class="right-one-o">
						<a href="#" class="right-one">
							<img src="../../images/s7.jpg">
							<div>全球最适合宜居养老的美景地</div>
						</a>
						<a href="#" class="right-one">
							<img src="../../images/s8.jpg">
							<div>理性精密又开放的德国人是怎么造酒店的</div>
						</a>
					</div>
					<div class="subject-top">
						<div class="subject-top-hr"></div>
						<div class="subject-top-title">热门地点</div>
					</div>
					<div class="right-six">
						<a href="#">
							<img src="../../images/h7.jpg">
							<div class="six-text">特雷麦梭大酒店：科莫湖的浪漫邂逅</div>
						</a>
					</div>
					<div class="right-six">
						<a href="#">
							<img src="../../images/h19.jpg">
							<div class="six-text">带着欢愉行走 自驾加拿大荒野公路</div>
						</a>
					</div>
					<div class="subject-top">
						<div class="subject-top-hr"></div>
						<div class="subject-top-title">两性</div>
					</div>
					<div class="right-five">
						<a href="#">
							<img src="../../images/h14.jpg">
							<div class="five-text">男人常常因为七件事搞砸爱情</div>
						</a>
					</div>
					<div class="right-five">
						<a href="#">
							<img src="../../images/h15.jpg">
							<div class="five-text">每一天都是热恋！8个技巧让你们永葆激情</div>
						</a>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-3">
					<a href="#" class="bottom-item">
						...
						<div>人均两三百元，在澳门能吃到这些米其林餐厅</div>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3">
					<a href="#" class="bottom-item">
						<img src="../../images/s11.jpg">
						<div>无辣不欢 辣酱汁的世界之旅</div>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3">
					<a href="#" class="bottom-item">
						<img src="../../images/s12.jpg">
						<div>对葡萄酒无爱？让苹果酒带你看世界</div>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3">
					<a href="#" class="bottom-item">
						<img src="../../images/h17.jpg">
						<div>从司康饼Scone开始 弄懂英式下午茶的一切</div>
					</a>
				</div>
			</div>
		</div>
	...
	<script src="../../js/life_emotion.js"></script>
