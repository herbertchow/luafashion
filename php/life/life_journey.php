...
<head>
	...
	<title>旅行--路雅时尚网</title>
	<link rel="stylesheet" href="../../bootstrap/css/bootstrap.min.css">
	<link rel="stylesheet" href="../../font-awesome/css/font-awesome.min.css">
	<link rel="stylesheet" href="../../css/public.css">
	<link rel="stylesheet" href="../../css/life_journey.css">
	<!--[if lt IE 9]>
...
<body class="fashion">
			...
			<div class="row">
				<div class="col-xs-12 padding-noh">
					<div class="title-anchor">
						<span>当前位置：<a href="../../index.php">首页</a> > <a href="life_index.php">生活</a> > 旅行</span>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="block2">
		<div class="container">
			<div class="row">
				<div class="col-xs-12">
					<div class="all-title">旅行 JOURNEY</div>
				</div>
				<div class="col-xs-12 col-sm-9">
					<a href="#" class="banner">
						<img src="../../images/s2.jpg">
						<div><span>春天一定要来这10座城市赏花</span></div>
					</a>
					<div class="item-wrap active" type="1">
						<div class="item-detail">
							<a href="#"><img src="../../images/h1.jpg"></a>
							<span class="detail-right">
								<a href="#"><span class="detail-title">十二星座最适合的旅行圣地</span></a>
								<span class="detail-text">选择去哪里旅行是个棘手的问题。你每天躺在沙滩上还
								是宁愿只是逛吃逛吃？为了帮助解决你的选择困难症，这里我们根据星座选择你应该
								去的旅行圣地。就现在......</span>
						...
						<div class="item-detail">
							...
							<span class="detail-right">
								<a href="#"><span class="detail-title">​美国游必去的八大公园</span></a>
								<span class="detail-text">这是一条有趣的新闻：2016年标志着美国国家公园基
								金会成立一百周年。而且不管你信不信，美国是59处华丽多样的国家公园的保护区。
								现在，让我为您挑选最值得假期旅行的八大去处......</span>
								<span class="detail-bottom"><i class="fa js-co fa-heart-o"></i>
									<a><span class="share-btn">分享</span><span class="share-wrap"><i class="fa fa-qq"></i>
									<i class="fa fa-weixin"></i><i class="fa fa-weibo"></i><i class="fa fa-close"></i></span></a>
								</span>
						...
						<div class="item-detail">
							...
							<span class="detail-right">
								<a href="#"><span class="detail-title">俄勒冈州人间花海的短期旅行</span></a>
								<span class="detail-text">几周前Julia决定去拜访她在康涅狄格的朋友卡莉。我决定
								给一些朋友发短信询问是否有人利用休假时间和我一起去旅行。幸运的是,我和的朋友Clayton
								都决定去波特兰,因为它是我们都想去但从来没有去过的地方......</span>
								<span class="detail-bottom"><i class="fa js-co fa-heart-o"></i>
									<a><span class="share-btn">分享</span><span class="share-wrap"><i class="fa fa-qq"></i>
									<i class="fa fa-weixin"></i><i class="fa fa-weibo"></i><i class="fa fa-close"></i></span></a>
								</span>
						...
						<div class="item-detail">
							<a href="life_3.php"><img src="../../images/h4.jpg"></a>
							<span class="detail-right">
								<a href="life_3.php"><span class="detail-title">普吉岛 少数派“泰”会享受</span></a>
								<span class="detail-text">大多数人是为了享受原始、清新的海岛生活而来，感受在晨雾中漫步于沙滩
								上的寂静氛围。虽然普吉岛终于也变成了一个拥挤的亚洲乐园，但是很庆幸自己成为选对了酒店的那少数
								人，还能感受它的美好时光......</span>
								<span class="detail-bottom"><i class="fa js-co fa-heart-o"></i>
									<a><span class="share-btn">分享</span><span class="share-wrap"><i class="fa fa-qq"></i>
									<i class="fa fa-weixin"></i><i class="fa fa-weibo"></i><i class="fa fa-close"></i></span></a>
						...
						<div class="item-detail">
							<a href="#"><img src="../../images/h5.jpg"></a>
							<span class="detail-right">
								<a href="#"><span class="detail-title">城市闪电约会 24小时玩转一座城！</span></a>
								<span class="detail-text">导语：既然罗马不是一天建成的，那一天内玩转一座城市的确是
								件让人纠结的事。很多时候我们没有充裕的时间去仔细看一个城市，这种情形对商务客人尤为
								常见，如何规划短暂的城市旅行，获得高效......</span>
								<span class="detail-bottom"><i class="fa js-co fa-heart-o"></i>
									<a><span class="share-btn">分享</span><span class="share-wrap"><i class="fa fa-qq"></i>
									<i class="fa fa-weixin"></i><i class="fa fa-weibo"></i><i class="fa fa-close"></i></span></a>
								</span>
				...
				<div class="col-xs-12 col-sm-3">
					...
					<div class="right-six">
						<a href="#">
							...
							<div class="six-text">全球最浪漫的冬季度假城市</div>
						</a>
					</div>
					<div class="right-six">
						<a href="#">
					...
					<div class="right-five">
						<a href="#">
							...
							<div class="five-text">优秀男人改变女性外在与内涵</div>
						</a>
					</div>
					<div class="right-five">
						<a href="#">
							<img src="../../images/h8.jpg">
							<div class="five-text">若是有这些迹象男人已爱上你</div>
						</a>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-3">
					<a href="#" class="bottom-item">
						...
						<div>“迷你型”女生的7个魅力瞬间</div>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3">
					<a href="#" class="bottom-item">
						<img src="../../images/s14.jpg">
						<div>选对6种旺妻男 生活甜似蜜糖</div>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3">
					<a href="#" class="bottom-item">
						<img src="../../images/h10.jpg">
						<div>这是个男人钟爱坏女人的时代</div>
					</a>
				</div>
				<div class="col-xs-12 col-sm-3">
					<a href="#" class="bottom-item">
						<img src="../../images/h11.jpg">
						<div>拥有这些特征的渣男谨慎交往</div>
					</a>
				</div>
			</div>
		</div>
	...
	<script src="../../js/life_journey.js"></script>
